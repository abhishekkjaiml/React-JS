...
const HomePage = ({ product }) => {
  ...
  const isProductInCart = findProductInCart(cart, product);
          ...
          <div className="relative z-10 flex min-h-120 items-center">
            ...
            <div className="w-full lg:w-[52%]">
              ...
              <h1 className="mt-6 max-w-155 text-4xl font-bold leading-tight text-text-primary sm:text-5xl lg:text-6xl">
                ...
                Amazing Price
                <br />
                <span className="text-info">Everyday</span>
              </h1>

              <p className="mt-5 max-w-130 text-base leading-7 text-text-muted sm:text-lg">
                Shop the latest trends and best deals on electronics, fashion,
                home & living, beauty, sports and more.
              </p>
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <button
                  onClick={onCartClick}
                  className="mt-4 flex h-10 w-full items-center justify-center gap-2 rounded-md bg-indigo-600 font-semibold text-white transition hover:bg-primary-dark"
                >
                  <ShoppingCartOutlinedIcon fontSize="small" />
                  Add to Cart
                </button>

                <button className="mt-4 flex h-10 w-full items-center justify-center gap-2 rounded-md bg-gray-900 font-semibold text-white transition hover:bg-gray-700">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-linear-to-r from-primary to-secondary px-6 py-10 sm:px-10">
          <div className="relative z-10 max-w-xl">
            ...
            <p className="mt-3 text-sm leading-6 text-white/80">
              Discover amazing deals across selected products. Grab your
              favorites before the offer ends.
            </p>

            <button
              onClick={() => navigate("/shop")}
              className="mt-6 rounded-md bg-white px-6 py-3 font-semibold text-primary transition hover:bg-primary-light"
            >
              Shop Deals
            </button>
          </div>
